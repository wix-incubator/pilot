...
import {breakReviewArrayToOutputsMapping, breakReviewArrayToItsTypes} from "./reviews-utils";

const AUTOPILOT_REVIEW = [
    {
        title: "Performance Testing",
        emoji: "🚀",
        description: "The Performance Testing Review focuses on the speed and responsiveness of the product. This review assesses the loading times, animations, and transitions of the UI components.",
        guidelines: [
...
describe("Reviews Utils", () => {
    describe("breakReviewArrayToOutputsMapping", () => {
        it("should return the correct OutputsMapping with default", () => {
            ...
            const result = breakReviewArrayToOutputsMapping(AUTOPILOT_REVIEW_DEFAULTS);
            expect(result).toEqual(expected);
        });

        it("should return the correct OutputsMapping with two-words review type", () => {
            const expected: OutputsMapping = {
                ["Performance Testing"]: {tag: "PERFORMANCE TESTING", isRequired: true}
            };
