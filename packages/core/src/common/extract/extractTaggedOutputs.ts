...
/**
 * Extracts the single-line goal from text generated by the user story to goal prompt.
 * Throws an error if the <GOAL> tag is missing.
 * @param text The full response text containing <GOAL> ... </GOAL>
 */
